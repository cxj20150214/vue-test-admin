<template>
  <div class="app-container">
    ...
    <el-dialog  @close="Reload()"  width="80%" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" :close-on-press-escape="dialogEsc" :close-on-click-modal="dialogEsc" >
  ...
  data() {
    return {
      ...
      rules: {
        ...
        category_id: [{ required: true, message: '分类id为必填项', trigger: 'blur' }]
      },
